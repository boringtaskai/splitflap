...
cavity_top_allowance = 1;  // extra case height above the flaps

flap_clearance = 0.5;  // distance between the flap edges and the case walls
wall_thickness = 2.0;  // thickness of the case walls around the flaps
...
fillet_case_corners = 2.0;  // bottom outside corner fillet
