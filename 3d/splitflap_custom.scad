...
module flap_spool_complete(captive_nut=false, motor_shaft=false, magnet_hole=false) {
    ...
    echo(num_flaps=num_flaps,flap_hole_radius=flap_hole_radius,flap_hole_separation=flap_hole_separation,flap_spool_outset=flap_spool_outset,height=thickness);
...
module front_tabs_negative(upper, tool_diameter=0) {
    ...
    // echo(num_front_tabs=num_front_tabs); => 2
...
module enclosure_front_cutouts_2d(tool_diameter=0) {
    ...
    // Front lower tabs
//    echo(enclosure_vertical_inset = enclosure_vertical_inset);
//    echo(thickness=thickness * 0.5);
...
module enclosure_front_cutouts_2d_custom(tool_diameter=0) {
